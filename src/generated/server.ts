...
class JoinRequest$Type extends MessageType<JoinRequest> {
	...
	create(value?: PartialMessage<JoinRequest>): JoinRequest {
		...
		message.teamSide = 0;
		message.number = 0;
		if (value !== undefined) reflectionMergePartial<JoinRequest>(this, message, value);
		return message;
	}
	...
	internalBinaryWrite(message: JoinRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		...
		if (message.protocolVersion !== "") writer.tag(2, WireType.LengthDelimited).string(message.protocolVersion);
		/* lugo.Team.Side team_side = 3; */
		if (message.teamSide !== 0) writer.tag(3, WireType.Varint).int32(message.teamSide);
		/* uint32 number = 4; */
		if (message.number !== 0) writer.tag(4, WireType.Varint).uint32(message.number);
		/* lugo.Point init_position = 5; */
		if (message.initPosition) Point.internalBinaryWrite(message.initPosition, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
...
class GameSnapshot$Type extends MessageType<GameSnapshot> {
	...
	create(value?: PartialMessage<GameSnapshot>): GameSnapshot {
		...
		if (value !== undefined) reflectionMergePartial<GameSnapshot>(this, message, value);
		return message;
	}
	...
	internalBinaryWrite(message: GameSnapshot, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		...
		/* uint32 turn = 2; */
		if (message.turn !== 0) writer.tag(2, WireType.Varint).uint32(message.turn);
		/* lugo.Team home_team = 3; */
		if (message.homeTeam) Team.internalBinaryWrite(message.homeTeam, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
		/* lugo.Team away_team = 4; */
		if (message.awayTeam) Team.internalBinaryWrite(message.awayTeam, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
		/* lugo.Ball ball = 5; */
		if (message.ball) Ball.internalBinaryWrite(message.ball, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
		/* uint32 turns_ball_in_goal_zone = 6; */
		if (message.turnsBallInGoalZone !== 0) writer.tag(6, WireType.Varint).uint32(message.turnsBallInGoalZone);
		/* lugo.ShotClock shot_clock = 7; */
		if (message.shotClock) ShotClock.internalBinaryWrite(message.shotClock, writer.tag(7, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class Team$Type extends MessageType<Team> {
	...
	internalBinaryWrite(message: Team, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		...
		/* uint32 score = 3; */
		if (message.score !== 0) writer.tag(3, WireType.Varint).uint32(message.score);
		/* lugo.Team.Side side = 4; */
		if (message.side !== 0) writer.tag(4, WireType.Varint).int32(message.side);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class ShotClock$Type extends MessageType<ShotClock> {
	...
	create(value?: PartialMessage<ShotClock>): ShotClock {
		...
		if (value !== undefined) reflectionMergePartial<ShotClock>(this, message, value);
		return message;
	}
	...
	internalBinaryWrite(message: ShotClock, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		...
		if (message.teamSide !== 0) writer.tag(6, WireType.Varint).int32(message.teamSide);
		/* uint32 remaining_turns = 7; */
		if (message.remainingTurns !== 0) writer.tag(7, WireType.Varint).uint32(message.remainingTurns);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class Player$Type extends MessageType<Player> {
	...
	internalBinaryWrite(message: Player, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		/* uint32 number = 1; */
		if (message.number !== 0) writer.tag(1, WireType.Varint).uint32(message.number);
		/* lugo.Point position = 2; */
		if (message.position) Point.internalBinaryWrite(message.position, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
		/* lugo.Velocity velocity = 3; */
		if (message.velocity) Velocity.internalBinaryWrite(message.velocity, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
		/* lugo.Team.Side team_side = 4; */
		if (message.teamSide !== 0) writer.tag(4, WireType.Varint).int32(message.teamSide);
		/* lugo.Point init_position = 5; */
		if (message.initPosition) Point.internalBinaryWrite(message.initPosition, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
		/* bool is_jumping = 6; */
		if (message.isJumping !== false) writer.tag(6, WireType.Varint).bool(message.isJumping);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class Ball$Type extends MessageType<Ball> {
	...
	create(value?: PartialMessage<Ball>): Ball {
		const message = globalThis.Object.create(this.messagePrototype!);
		if (value !== undefined) reflectionMergePartial<Ball>(this, message, value);
		return message;
	}
	...
	internalBinaryWrite(message: Ball, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		...
		if (message.position) Point.internalBinaryWrite(message.position, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
		/* lugo.Velocity velocity = 2; */
		if (message.velocity) Velocity.internalBinaryWrite(message.velocity, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
		/* lugo.Player holder = 3; */
		if (message.holder) Player.internalBinaryWrite(message.holder, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class OrderResponse$Type extends MessageType<OrderResponse> {
	...
	create(value?: PartialMessage<OrderResponse>): OrderResponse {
		...
		message.code = 0;
		message.details = "";
		if (value !== undefined) reflectionMergePartial<OrderResponse>(this, message, value);
		return message;
	}
	...
	internalBinaryWrite(message: OrderResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		...
		/* string details = 2; */
		if (message.details !== "") writer.tag(2, WireType.LengthDelimited).string(message.details);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class OrderSet$Type extends MessageType<OrderSet> {
	...
	create(value?: PartialMessage<OrderSet>): OrderSet {
		...
		if (value !== undefined) reflectionMergePartial<OrderSet>(this, message, value);
		return message;
	}
	...
	internalBinaryWrite(message: OrderSet, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		/* uint32 turn = 1; */
		if (message.turn !== 0) writer.tag(1, WireType.Varint).uint32(message.turn);
		...
		if (message.debugMessage !== "") writer.tag(3, WireType.LengthDelimited).string(message.debugMessage);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class Order$Type extends MessageType<Order> {
	...
	internalBinaryWrite(message: Order, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		/* lugo.Move move = 1; */
		if (message.action.oneofKind === "move") Move.internalBinaryWrite(message.action.move, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
		/* lugo.Catch catch = 2; */
		if (message.action.oneofKind === "catch") Catch.internalBinaryWrite(message.action.catch, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
		/* lugo.Kick kick = 3; */
		if (message.action.oneofKind === "kick") Kick.internalBinaryWrite(message.action.kick, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
		/* lugo.Jump jump = 4; */
		if (message.action.oneofKind === "jump") Jump.internalBinaryWrite(message.action.jump, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class Move$Type extends MessageType<Move> {
	constructor() {
		super("lugo.Move", [{ no: 1, name: "velocity", kind: "message", T: () => Velocity }]);
	}
	create(value?: PartialMessage<Move>): Move {
		const message = globalThis.Object.create(this.messagePrototype!);
		if (value !== undefined) reflectionMergePartial<Move>(this, message, value);
		return message;
	}
	...
	internalBinaryWrite(message: Move, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		...
		if (message.velocity) Velocity.internalBinaryWrite(message.velocity, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class Catch$Type extends MessageType<Catch> {
	...
	create(value?: PartialMessage<Catch>): Catch {
		const message = globalThis.Object.create(this.messagePrototype!);
		if (value !== undefined) reflectionMergePartial<Catch>(this, message, value);
		return message;
	}
...
class Kick$Type extends MessageType<Kick> {
	constructor() {
		super("lugo.Kick", [{ no: 1, name: "velocity", kind: "message", T: () => Velocity }]);
	}
	create(value?: PartialMessage<Kick>): Kick {
		const message = globalThis.Object.create(this.messagePrototype!);
		if (value !== undefined) reflectionMergePartial<Kick>(this, message, value);
		return message;
	}
...
class Jump$Type extends MessageType<Jump> {
	constructor() {
		super("lugo.Jump", [{ no: 1, name: "velocity", kind: "message", T: () => Velocity }]);
	}
	create(value?: PartialMessage<Jump>): Jump {
		const message = globalThis.Object.create(this.messagePrototype!);
		if (value !== undefined) reflectionMergePartial<Jump>(this, message, value);
		return message;
	}
