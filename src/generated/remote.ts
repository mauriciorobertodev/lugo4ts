...
class PauseResumeRequest$Type extends MessageType<PauseResumeRequest> {
	...
	create(value?: PartialMessage<PauseResumeRequest>): PauseResumeRequest {
		...
		if (value !== undefined) reflectionMergePartial<PauseResumeRequest>(this, message, value);
		return message;
	}
...
class NextTurnRequest$Type extends MessageType<NextTurnRequest> {
	...
	create(value?: PartialMessage<NextTurnRequest>): NextTurnRequest {
		const message = globalThis.Object.create(this.messagePrototype!);
		if (value !== undefined) reflectionMergePartial<NextTurnRequest>(this, message, value);
		return message;
	}
...
class NextOrderRequest$Type extends MessageType<NextOrderRequest> {
	...
	create(value?: PartialMessage<NextOrderRequest>): NextOrderRequest {
		const message = globalThis.Object.create(this.messagePrototype!);
		if (value !== undefined) reflectionMergePartial<NextOrderRequest>(this, message, value);
		return message;
	}
...
class BallProperties$Type extends MessageType<BallProperties> {
	...
	create(value?: PartialMessage<BallProperties>): BallProperties {
		const message = globalThis.Object.create(this.messagePrototype!);
		if (value !== undefined) reflectionMergePartial<BallProperties>(this, message, value);
		return message;
	}
...
class PlayerProperties$Type extends MessageType<PlayerProperties> {
	...
	create(value?: PartialMessage<PlayerProperties>): PlayerProperties {
		...
		message.side = 0;
		message.number = 0;
		if (value !== undefined) reflectionMergePartial<PlayerProperties>(this, message, value);
		return message;
	}
	...
	internalBinaryWrite(message: PlayerProperties, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		...
		/* uint32 number = 2; */
		if (message.number !== 0) writer.tag(2, WireType.Varint).uint32(message.number);
		/* lugo.Point position = 3; */
		if (message.position) Point.internalBinaryWrite(message.position, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
		/* lugo.Velocity velocity = 4; */
		if (message.velocity) Velocity.internalBinaryWrite(message.velocity, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class GameProperties$Type extends MessageType<GameProperties> {
	...
	create(value?: PartialMessage<GameProperties>): GameProperties {
		...
		if (value !== undefined) reflectionMergePartial<GameProperties>(this, message, value);
		return message;
	}
	...
	internalBinaryWrite(message: GameProperties, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		...
		/* uint32 home_score = 2; */
		if (message.homeScore !== 0) writer.tag(2, WireType.Varint).uint32(message.homeScore);
		/* uint32 away_score = 3; */
		if (message.awayScore !== 0) writer.tag(3, WireType.Varint).uint32(message.awayScore);
		/* int64 frame_interval = 4; */
		if (message.frameInterval !== 0n) writer.tag(4, WireType.Varint).int64(message.frameInterval);
		/* lugo.ShotClock shot_clock = 5; */
		if (message.shotClock) ShotClock.internalBinaryWrite(message.shotClock, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class CommandResponse$Type extends MessageType<CommandResponse> {
	...
	create(value?: PartialMessage<CommandResponse>): CommandResponse {
		...
		message.code = 0;
		message.details = "";
		if (value !== undefined) reflectionMergePartial<CommandResponse>(this, message, value);
		return message;
	}
	...
	internalBinaryWrite(message: CommandResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		...
		if (message.gameSnapshot) GameSnapshot.internalBinaryWrite(message.gameSnapshot, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
		/* string details = 3; */
		if (message.details !== "") writer.tag(3, WireType.LengthDelimited).string(message.details);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class ResumeListeningRequest$Type extends MessageType<ResumeListeningRequest> {
	...
	create(value?: PartialMessage<ResumeListeningRequest>): ResumeListeningRequest {
		const message = globalThis.Object.create(this.messagePrototype!);
		if (value !== undefined) reflectionMergePartial<ResumeListeningRequest>(this, message, value);
		return message;
	}
...
class ResumeListeningResponse$Type extends MessageType<ResumeListeningResponse> {
	...
	create(value?: PartialMessage<ResumeListeningResponse>): ResumeListeningResponse {
		const message = globalThis.Object.create(this.messagePrototype!);
		if (value !== undefined) reflectionMergePartial<ResumeListeningResponse>(this, message, value);
		return message;
	}
...
class ResetPlayerPositionsRequest$Type extends MessageType<ResetPlayerPositionsRequest> {
	...
	create(value?: PartialMessage<ResetPlayerPositionsRequest>): ResetPlayerPositionsRequest {
		const message = globalThis.Object.create(this.messagePrototype!);
		if (value !== undefined) reflectionMergePartial<ResetPlayerPositionsRequest>(this, message, value);
		return message;
	}
...
class ResetPlayerPositionsResponse$Type extends MessageType<ResetPlayerPositionsResponse> {
	constructor() {
		super("lugo.ResetPlayerPositionsResponse", [{ no: 1, name: "game_snapshot", kind: "message", T: () => GameSnapshot }]);
	}
	create(value?: PartialMessage<ResetPlayerPositionsResponse>): ResetPlayerPositionsResponse {
		const message = globalThis.Object.create(this.messagePrototype!);
		if (value !== undefined) reflectionMergePartial<ResetPlayerPositionsResponse>(this, message, value);
		return message;
	}
...
class GameSnapshotRequest$Type extends MessageType<GameSnapshotRequest> {
	...
	create(value?: PartialMessage<GameSnapshotRequest>): GameSnapshotRequest {
		const message = globalThis.Object.create(this.messagePrototype!);
		if (value !== undefined) reflectionMergePartial<GameSnapshotRequest>(this, message, value);
		return message;
	}
...
class GameSnapshotResponse$Type extends MessageType<GameSnapshotResponse> {
	constructor() {
		super("lugo.GameSnapshotResponse", [{ no: 1, name: "game_snapshot", kind: "message", T: () => GameSnapshot }]);
	}
	create(value?: PartialMessage<GameSnapshotResponse>): GameSnapshotResponse {
		const message = globalThis.Object.create(this.messagePrototype!);
		if (value !== undefined) reflectionMergePartial<GameSnapshotResponse>(this, message, value);
		return message;
	}
