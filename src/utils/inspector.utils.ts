...
import type { GameInspectorObject } from "@/interfaces/inspector.interface.js";
import { PlayerState } from "@/interfaces/player.interface.js";
import { fromBallObject, randomBall } from "@/utils/ball.utils.js";
import { randomPlayerState } from "@/utils/player.utils.js";
import { randomInt } from "@/utils/random.utils.js";
import { fromShotClockObject, randomShotClock } from "@/utils/shot-clock.utils.js";
import { randomSide } from "@/utils/side.utils.js";
...
export function randomGameInspectorInOnDefending({
	...
	const holderOpponent = playerSide === Side.HOME ? awayTeam.getPlayer(playerNumber) : homeTeam.getPlayer(playerNumber);
...
export function randomGameInspectorInOnSupporting({
	...
	const holderAlly = playerSide === Side.HOME ? homeTeam.getRandomPlayer([playerNumber]) : awayTeam.getRandomPlayer([playerNumber]);
