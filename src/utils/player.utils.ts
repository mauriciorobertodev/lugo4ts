...
import { type PlayerObject, PlayerState } from "@/interfaces/player.interface.js";

import { goalFromSide } from "@/utils/goal.utils.js";
import { fromPointObject, randomInitialPosition, randomPointBetweenGoalPoles, randomPointInField } from "@/utils/point.utils.js";
import { randomElement, randomInt } from "@/utils/random.utils.js";
import { randomVector2D } from "@/utils/vector.utils.js";
import { fromVelocityObject, randomVelocity } from "@/utils/velocity.utils.js";
...
export function fromPlayerObject(obj: PlayerObject): Player {
	return new Player(obj.number, obj.isJumping, obj.side, fromPointObject(obj.position), fromPointObject(obj.initPosition), fromVelocityObject(obj.velocity));
}
...
export function randomPlayer({
	...
	const secondaryInitialPosition = isGoalkeeper ? randomPointBetweenGoalPoles(goalFromSide(side)) : randomInitialPosition(side);
