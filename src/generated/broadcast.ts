...
class WatcherRequest$Type extends MessageType<WatcherRequest> {
	constructor() {
		super("lugo.WatcherRequest", [{ no: 1, name: "uuid", kind: "scalar", T: 9 /*ScalarType.STRING*/ }]);
	}
	create(value?: PartialMessage<WatcherRequest>): WatcherRequest {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.uuid = "";
		if (value !== undefined) reflectionMergePartial<WatcherRequest>(this, message, value);
		return message;
	}
...
class StartRequest$Type extends MessageType<StartRequest> {
	constructor() {
		super("lugo.StartRequest", [{ no: 1, name: "watcher_uuid", kind: "scalar", T: 9 /*ScalarType.STRING*/ }]);
	}
	create(value?: PartialMessage<StartRequest>): StartRequest {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.watcherUuid = "";
		if (value !== undefined) reflectionMergePartial<StartRequest>(this, message, value);
		return message;
	}
	...
	internalBinaryWrite(message: StartRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		...
		if (message.watcherUuid !== "") writer.tag(1, WireType.LengthDelimited).string(message.watcherUuid);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class GameEvent$Type extends MessageType<GameEvent> {
	...
	create(value?: PartialMessage<GameEvent>): GameEvent {
		...
		if (value !== undefined) reflectionMergePartial<GameEvent>(this, message, value);
		return message;
	}
	...
	internalBinaryWrite(message: GameEvent, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		...
		if (message.gameSnapshot) GameSnapshot.internalBinaryWrite(message.gameSnapshot, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
		...
		if (message.event.oneofKind === "goal") EventGoal.internalBinaryWrite(message.event.goal, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
...
class GameSetup$Type extends MessageType<GameSetup> {
	...
	create(value?: PartialMessage<GameSetup>): GameSetup {
		...
		if (value !== undefined) reflectionMergePartial<GameSetup>(this, message, value);
		return message;
	}
	...
	internalBinaryWrite(message: GameSetup, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		...
		if (message.protocolVersion !== "") writer.tag(1, WireType.LengthDelimited).string(message.protocolVersion);
		/* bool dev_mode = 2; */
		if (message.devMode !== false) writer.tag(2, WireType.Varint).bool(message.devMode);
		/* lugo.GameSetup.StartingMode start_mode = 3; */
		if (message.startMode !== 0) writer.tag(3, WireType.Varint).int32(message.startMode);
		/* lugo.GameSetup.ListeningMode listening_mode = 4; */
		if (message.listeningMode !== 0) writer.tag(4, WireType.Varint).int32(message.listeningMode);
		/* uint32 listening_duration = 5; */
		if (message.listeningDuration !== 0) writer.tag(5, WireType.Varint).uint32(message.listeningDuration);
		/* uint32 game_duration = 6; */
		if (message.gameDuration !== 0) writer.tag(6, WireType.Varint).uint32(message.gameDuration);
		/* lugo.TeamSettings home_team = 8; */
		if (message.homeTeam) TeamSettings.internalBinaryWrite(message.homeTeam, writer.tag(8, WireType.LengthDelimited).fork(), options).join();
		/* lugo.TeamSettings away_team = 9; */
		if (message.awayTeam) TeamSettings.internalBinaryWrite(message.awayTeam, writer.tag(9, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class TeamSettings$Type extends MessageType<TeamSettings> {
	...
	create(value?: PartialMessage<TeamSettings>): TeamSettings {
		...
		message.name = "";
		message.avatar = "";
		if (value !== undefined) reflectionMergePartial<TeamSettings>(this, message, value);
		return message;
	}
	...
	internalBinaryWrite(message: TeamSettings, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		...
		/* string avatar = 2; */
		if (message.avatar !== "") writer.tag(2, WireType.LengthDelimited).string(message.avatar);
		/* lugo.TeamColors colors = 3; */
		if (message.colors) TeamColors.internalBinaryWrite(message.colors, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class TeamColors$Type extends MessageType<TeamColors> {
	...
	create(value?: PartialMessage<TeamColors>): TeamColors {
		const message = globalThis.Object.create(this.messagePrototype!);
		if (value !== undefined) reflectionMergePartial<TeamColors>(this, message, value);
		return message;
	}
	...
	internalBinaryWrite(message: TeamColors, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		...
		if (message.primary) TeamColor.internalBinaryWrite(message.primary, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
		/* lugo.TeamColor secondary = 2; */
		if (message.secondary) TeamColor.internalBinaryWrite(message.secondary, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class TeamColor$Type extends MessageType<TeamColor> {
	...
	create(value?: PartialMessage<TeamColor>): TeamColor {
		...
		message.green = 0;
		message.blue = 0;
		if (value !== undefined) reflectionMergePartial<TeamColor>(this, message, value);
		return message;
	}
	...
	internalBinaryWrite(message: TeamColor, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		/* uint32 red = 1; */
		if (message.red !== 0) writer.tag(1, WireType.Varint).uint32(message.red);
		/* uint32 green = 2; */
		if (message.green !== 0) writer.tag(2, WireType.Varint).uint32(message.green);
		/* uint32 blue = 4; */
		if (message.blue !== 0) writer.tag(4, WireType.Varint).uint32(message.blue);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class EventNewPlayer$Type extends MessageType<EventNewPlayer> {
	constructor() {
		super("lugo.EventNewPlayer", [{ no: 1, name: "player", kind: "message", T: () => Player }]);
	}
	create(value?: PartialMessage<EventNewPlayer>): EventNewPlayer {
		const message = globalThis.Object.create(this.messagePrototype!);
		if (value !== undefined) reflectionMergePartial<EventNewPlayer>(this, message, value);
		return message;
	}
	...
	internalBinaryWrite(message: EventNewPlayer, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		...
		if (message.player) Player.internalBinaryWrite(message.player, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class EventLostPlayer$Type extends MessageType<EventLostPlayer> {
	constructor() {
		super("lugo.EventLostPlayer", [{ no: 1, name: "player", kind: "message", T: () => Player }]);
	}
	create(value?: PartialMessage<EventLostPlayer>): EventLostPlayer {
		const message = globalThis.Object.create(this.messagePrototype!);
		if (value !== undefined) reflectionMergePartial<EventLostPlayer>(this, message, value);
		return message;
	}
...
class EventStateChange$Type extends MessageType<EventStateChange> {
	...
	create(value?: PartialMessage<EventStateChange>): EventStateChange {
		...
		message.newState = 0;
		if (value !== undefined) reflectionMergePartial<EventStateChange>(this, message, value);
		return message;
	}
	...
	internalBinaryWrite(message: EventStateChange, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		...
		if (message.previousState !== 0) writer.tag(1, WireType.Varint).int32(message.previousState);
		/* lugo.GameSnapshot.State new_state = 2; */
		if (message.newState !== 0) writer.tag(2, WireType.Varint).int32(message.newState);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class EventGoal$Type extends MessageType<EventGoal> {
	constructor() {
		super("lugo.EventGoal", [{ no: 1, name: "side", kind: "enum", T: () => ["lugo.Team.Side", Team_Side] }]);
	}
	create(value?: PartialMessage<EventGoal>): EventGoal {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.side = 0;
		if (value !== undefined) reflectionMergePartial<EventGoal>(this, message, value);
		return message;
	}
	...
	internalBinaryWrite(message: EventGoal, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		...
		if (message.side !== 0) writer.tag(1, WireType.Varint).int32(message.side);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class EventGameOver$Type extends MessageType<EventGameOver> {
	...
	create(value?: PartialMessage<EventGameOver>): EventGameOver {
		...
		message.reason = 0;
		message.blame = 0;
		if (value !== undefined) reflectionMergePartial<EventGameOver>(this, message, value);
		return message;
	}
	...
	internalBinaryWrite(message: EventGameOver, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		...
		if (message.reason !== 0) writer.tag(1, WireType.Varint).int32(message.reason);
		/* lugo.EventGameOver.BlameStop blame = 2; */
		if (message.blame !== 0) writer.tag(2, WireType.Varint).int32(message.blame);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class EventDebugBreakpoint$Type extends MessageType<EventDebugBreakpoint> {
	...
	create(value?: PartialMessage<EventDebugBreakpoint>): EventDebugBreakpoint {
		...
		if (value !== undefined) reflectionMergePartial<EventDebugBreakpoint>(this, message, value);
		return message;
	}
	...
	internalBinaryWrite(message: EventDebugBreakpoint, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
		...
		if (message.breakpoint !== 0) writer.tag(1, WireType.Varint).int32(message.breakpoint);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
class EventDebugReleased$Type extends MessageType<EventDebugReleased> {
	...
	create(value?: PartialMessage<EventDebugReleased>): EventDebugReleased {
		const message = globalThis.Object.create(this.messagePrototype!);
		if (value !== undefined) reflectionMergePartial<EventDebugReleased>(this, message, value);
		return message;
	}
